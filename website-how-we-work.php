      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
          <div class="s-block wide-sblock">
            ...
            <div class="s-block-content">
              <h4>Creating</h4>
            <p>We monitor the need closely and create the best solution for you.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
          <div class="s-block wide-sblock">
            ...
            <div class="s-block-content">
              <h4>Delivering</h4>
            <p> We finally deliver you the best.
				</p>
            </div>
          </div>
        </div>
...
<style>
    ...
    border-radius: 0px;
    -webkit-box-shadow:0 0px 0px -30px rgba(0, 0, 0, 0), 0 0px 0px -30px rgba(0, 0, 0, 0), 0 0px 0px -30px rgba(0, 0, 0, 0);
    box-shadow: 0 0px 0px -30px rgba(0, 0, 0, 0), 0 0px 0px -30px rgba(0, 0, 0, 0), 0 0px 0px -30px rgba(0, 0, 0, 0);
}
.small1{
	width:20%;
	margin-bottom:10px;
...
<h2 class="mb30">Web Development Process</h2>
	<p>Here are the reasons that make ReactJS our first choice when it comes to building ‘beauty with brilliance’ apps</p>
</div>
</div>
</div>

<div class="row upset  shape-num justify-content-center">
<div class="col-md-5th-1  shape-loc wow fadeInUp small1" >
<div class="s-block">

<h4 class="h41">Preparation/Brief</h4>
<p>
...
<div class=" col-md-5th-1  shape-loc wow fadeInUp small1" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;" style="width:20%">
...
<h4 class="h41">Planning</h4>
<p>
Identify what is needed
in terms of content, features
...
<h4 class="h41">Production</h4>
<p>

The exciting bit – at the end of this process you have a completed website</p>
</div>
</div>
<div class=" col-md-5th-1  shape-loc wow fadeInUp small1" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;" style="width:20%">
<div class="s-block" data-tilt="" data-tilt-max="5" data-tilt-speed="1000" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1); transition: all 1000ms cubic-bezier(0.03, 0.98, 0.52, 0.99) 0s;">

<h4 class="h41">Launch(Put live)</h4>
<p>

Get the site operational,
put it live, and
setup the technology</p>
</div>
</div>
...
<h4 class="h41">Post Launch-Marketing</h4>
<p>
Making your website
“really” work for you in
terms of traffic and sales</p>
</div>
</div>
