...
<div class="row justify-content-center">
		...
		<div class="stamp-sheet">
		    <?php $sl=1;
                            include 'dbconn.php';
                            $sql2 = mysqli_query($conn, "SELECT * FROM w_portfolio ORDER BY id DESC");
                            while($info = mysqli_fetch_array($sql2))
                                  { 
                          ?>
		  <div class="col-md-4">
		      <div class=" stamp">
			<img src="erp/portfolio/<?php echo$info['img']; ?>">
		  </div>
		  <a href=""><h3 class="col text-center" style="color:black;"><?php echo$info['header']; ?></h3></a>
		  </div>
		  <?php  } ?>
