...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-lg-6 v-center">
      ...
      <div class="form-block" id="contact_form">
        <form id="contact-form" method="post" action="php/contact.php" data-toggle="validator">
          ...
          <div class="fieldsets row">
            ...
            <div class="help-block with-errors" id="name_error_header1">Enter a Valid Name</div></div>
            ...
            <div class="help-block with-errors" id="email_error_header1">Enter a Valid Emailid</div></div>
          </div>
          <div class="fieldsets row">
            ...
            <div class="help-block with-errors" id="phone_error_header1">Enter a Valid Phone Number</div></div>
           	 <div class="col-md-6 form-group"><input id="c_name1" pattern type="text" name="company name"  placeholder="Enter your company name *" required="required" data-error="company name is required.">
            <div class="help-block with-errors"></div></div>
          </div>
          <div class="fieldsets form-group"> <textarea id="message1" name="message"  placeholder="Message for me" rows="4" data-error="Please, leave us a message."></textarea>
          ...
          <div class="fieldsets mt20">
            <button type="button" class="lnk btn-main bg-btn contact_btn">Submit <span class="circle"></span></button>
          </div>
          <p class="trm"><i class="fas fa-lock"></i>We hate spam, and we respect your privacy.</p>
        </form>
      </div>
        <div class="bg-gradient16 pt30 pb30 mt30 mb30 text-w" id="contact_alert" style="background-image: linear-gradient(45deg,#73e600 0,#73e600 50%,#73e600 100%); text-align:center;">
                <h4> 
                    <i class="fas fa-check-circle"></i> Thanks for contacting us, we will get back to you soon
                </h4>
                </div>
    </div>
...
$(document).ready(function(){
  ...
  document.getElementById("phone_error_header1").style.display = "block";
    ...
    if(!document.getElementById("name1").checkValidity())
        { 
  document.getElementById("name_error_header1").style.display = "block";
        }
        else{
    document.getElementById("name_error_header1").style.display = "none";
  ...
  document.getElementById("contact_alert").style.display = "block";
