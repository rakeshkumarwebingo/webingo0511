...
<li data-filter=".website">VC</li>
<li data-filter=".app">Letter Head</li>
<li data-filter=".graphic">T-shirt</li>
</ul>
</div>
</div>
</div>
...
<?php $sl=1;
                            include 'dbconn.php';
                            $sql2 = mysqli_query($conn, "SELECT * FROM b_portfolio ORDER BY id DESC");
...
<a href="#"><img src="erp/portfolio/<?php echo$info['img']; ?>" alt="portfolio" class="img-fluid"/> </a>
</div>
<div class="item-info">
...
<div class="isotope_item hover-scale">
<div class="item-image">
<a href="#"><img src="images/portfolio/poster-1.jpg" alt="image" class="img-fluid"/> </a>
</div>
<div class="item-info">
