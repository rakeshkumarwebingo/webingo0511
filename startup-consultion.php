...
<div class="itm-media-object mt40">
	<div class="media">
		...
		<div class="media-body">
			...
			<p>
WEBINGO advises the best business structure to begin with your business, it does not matter whether it's a Pvt Ltd or LLP company along with proper certificate requirement control.</p>
		</div>
	</div>
	<div class="media mt40">
...
.</p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="common-heading">
            <h2 class="mb0 text-radius text-light text-animation bg-b">FAQS</h2>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div id="accordion2" class="accordion">
            <div class="card-1 ">
              ...
              <div id="collapse-6" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				No, we are management consultants, not investors.</p>
			  </div>
            </div>
			  <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: navy">
