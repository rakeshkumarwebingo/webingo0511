...
<div class="container">
	...
	<div class="col-lg-8">
		<div class="common-heading ptag">
			...
			<h2 style="font-size: 36px;" >What are the four major growth strategies?</h2>
			<p class="mb30">There are countless of growth strategies for businesses, but only four major types. With these growth strategies, you can determine how to build on your brand.</p>
		</div>
	</div>
</div>
<div class="row">
...
Business plan software has streamlined the growth plan process. Most software programs are geared to business plans, but you can modify them to create a plan that focuses on growth.</p>
		...
		<li>Review and revise your growth plan often.</li>

		<li style="text-align:justify;">Share your growth plan with key employees as a motivator. When employees see opportunity for increased responsibility and corresponding compensation, they're more likely to stay.</li>

		<li style="text-align:justify;">Your growth plan should also include an assessment of your operating systems and computer networks to determine if they can accommodate growth.</li>
		</ul>
</div>
        ...
        <div class="col-md-6 mt60">
          <div id="accordion" class="accordion">
            <div class="card-1">
             ...
             My company is small. We don’t have a lot of money. Isn’t strategic planning just for bigger companies?
                </button>
              </div>
              <div id="collapse-a" class="card-body collapse " aria-labelledby="faq1" data-parent="#accordion">
				...
				Strategic planning doesn’t necessarily mean producing a big, highly detailed document. It can be done on a smaller scale at a reasonable cost for businesses of any size.</p>
              </div>
            </div>
           <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: navy">
               ...
               How can I find time for strategic planning when I’m already swamped with the day-to-day business of running my company?
                </button>
              </div>
              <div id="collapse-d" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				Answer: Taking the time to work on your business instead of in your business will pay big dividends, including helping you be less swamped day to day. A strategic plan can help you focus on important issues, make decisions, delegate, reduce errors and not waste so much time putting out fires.</p>
              </div>
            </div>
          ...
          <div id="accordion2" class="accordion">
            <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: navy">
               ...
               Won’t strategic planning cause a lot of disruption to my business?
                </button>
              </div>
              <div id="collapse-4" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				Answer: Planning for your business may lead to changes in your company, but they will most likely be positive changes. The end result should be better decision making, wiser use of resources and improved growth and profit margins.<br>
				Also remember that change will happen anyway, regardless of whether you develop a business strategy. A plan will help you anticipate change and focus on the best opportunities, rather than reacting and letting change take you by surprise.</p>
              </div>
            </div>
			  <div class="card-1 ">
              <div class="card-header" id="faq4" style="background: navy">
             ...
             How can I plan long term when the future is so uncertain and I have no idea what will happen next week, let alone several years out?
              ...
              <div id="collapse-1" class="card-body collapse " aria-labelledby="faq4" data-parent="#accordion2">
                <p>
				Answer: Planning is needed precisely because the future is uncertain. The information you have today can be used to make reasonable forecasts of what the future might hold. Thinking about the future helps us plan what to do in various scenarios so we can be more ready for whatever it brings.</p>
              </div>
            </div>
