            ...
            <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
				<div class="banner_pic">
					<picture>
						...
						<img src="images/image2/future.png" alt="" />
					</picture>
				</div>
			</div>
			 <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
...
<span>GROW TRAFFIC &amp; INCREASE REVENUE</span>
	<h2 style="font-size:30px">What is a business growth plan?</h2>
	
<p style="text-align: justify">Business growth plans are short-term outlines for where a company sees itself in the next
one to two years. The growth plan should be formatted to follow along with each quarter.
At the end of each quarter, the company can review what goals were met and what goals
were missed during that period. At this point, management can revise the business growth
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3>Writing a growth plan is very similar to writing a business plan.</h3>
...
<div class="servie-key-points">
  <h4>Advantages of growth plan</h4>
  <ul class="key-points mt20">   
      <li>Think ahead.</li>
      <li>Study other growth plans.</li>
      <li>Discover opportunities for growth.</li>
      <li>Evaluate your team.</li>
      <li>Find the capital.</li>
